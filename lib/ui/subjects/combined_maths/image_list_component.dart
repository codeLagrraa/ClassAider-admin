...
class ImageListComponent extends StatefulWidget {
  const ImageListComponent({Key? key}) : super(key: key);

  @override
  _ImageListComponentState createState() => _ImageListComponentState();
}
...
class _ImageListComponentState extends State<ImageListComponent> {
  ...
  void initState() {
    ...
    futureFiles = FirebaseApi.listAll('images_math/');
  }
  ...
  Future<void> _upload(String inputSource) async {
    ...
    try {
      ...
      referenceRoot.child('images_math');
