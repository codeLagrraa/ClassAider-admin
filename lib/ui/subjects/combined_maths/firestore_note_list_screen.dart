...
import 'maths_welcome_screen.dart';
import 'add_firestore_note_data.dart';
...
class _FireStoreScreenState extends State<FireStoreScreen> {
  ...
  final fireStore = FirebaseFirestore.instance.collection('com_math_notes').snapshots();

  CollectionReference ref = FirebaseFirestore.instance.collection('com_math_notes');
